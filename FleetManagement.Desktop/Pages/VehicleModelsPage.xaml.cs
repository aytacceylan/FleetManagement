...
{
	public partial class VehicleModelsPage : Page
	{
		private readonly AppDbContext _db = new(App.DbOptions);

		private int? _selectedId;
		private List<VehicleModel> _all = new();
		...
		private async void Delete_Click(object sender, RoutedEventArgs e)
		{
			try
			{
				...
				var confirm = MessageBox.Show("Seçili model silinsin mi?", "Onay", MessageBoxButton.YesNo);
